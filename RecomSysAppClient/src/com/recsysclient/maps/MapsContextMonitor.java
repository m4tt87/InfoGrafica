...
public class MapsContextMonitor extends Service {
	...
	private MapsStatusDetector statusDetector;
	...
	public static final String CONTEXT_UPDATE = "com.recsysclient.maps.ContextUpdate";
	public static final String POSITION_UPDATE = "com.recsysclient.maps.PositionUpdate";
	...
	public void onCreate() {
		...
		interval_ms = 20;
		delay=0;
		statusDetector =  MapsStatusDetector.getInstance(this);
	}
