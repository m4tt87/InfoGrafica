...
public class MapsStatusDetector {
private static MapsStatusDetector istanza = null;
...
private float newBearing;
	...
	public MapsStatusDetector(Context context) {
	...
	public static synchronized MapsStatusDetector getInstance(Context context) {
		if (istanza == null)
			istanza = new MapsStatusDetector(context);
		return istanza;
	}
